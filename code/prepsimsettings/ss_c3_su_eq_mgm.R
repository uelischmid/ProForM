## create simsettings for c3_su_eq_mgm simulations
## 27.1.23, us
...
for (i in 1:nrow(combinations)) {
  ...
  # new file name
  filename_new <- str_c("simsettings_c3_su_eq_mgm_",
                        pull(vals, stratum), "_",
                        pull(vals, quality), ".csv")
  
  # sim name
  ss_new[[1, 2]] <- str_c("c3_su_eq_mgm_",
                          pull(vals, stratum), "_",
                          pull(vals, quality))
  ...
  # mgm
  ss_new[[18, 2]] <- "group_selection"
  ss_new[[19, 2]] <- str_c("c3_su/mgm_c3_su_eq_mgm_",
                           pull(vals, stratum), "_",
                           pull(vals, quality), ".csv")
