## create simsettings for c3_ST_def simulations
## 27.1.23, us
...
out_folder <- "data/processed/simsettings/c3_ST_def/"
...
for (i in 1:nrow(combinations)) {
  ...
  # new file name
  filename_new <- str_c("simsettings_c3_ST_def_",
                        pull(vals, stratum), "_",
                        pull(vals, quality), "_",
                        "init", pull(vals, init), "_",
