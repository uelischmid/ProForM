...
PROFORM_vis_1_nais_F2_relaxed <- function(nais_assessment, avg_across, out_subfolder) {
  # setup -------------------------------------------------------------------
  suppressWarnings(suppressMessages(library(tidyverse)))

  # load data ---------------------------------------------------------------
  nais_indices_red <- read_rds(str_c("data/processed/naisoutput/2_assessment_relaxed/", nais_assessment, "/nais_indices_red.rds"))
