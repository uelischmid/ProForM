...
PROFORM_NaiS_assess_relaxed <- function(nais_prep,
                                        natural_hazard,
                                        rockfall_scenario) {
  ...
  source("code/nais/functions_nais_relaxed.R", local = TRUE)
  ...
  if (natural_hazard == "RF") {
    output_folder <- str_c("data/processed/naisoutput/2_assessment_relaxed/", nais_prep, "_", natural_hazard, rockfall_scenario, "/")
  } else {
    output_folder <- str_c("data/processed/naisoutput/2_assessment_relaxed/", nais_prep, "_", natural_hazard, "/")
  }
